...
{
	outfile1.open("gyro_shoulder_5.txt", std::ios_base::app);
	outfile2.open("gyro_wrist_5.txt", std::ios_base::app);
...
void getAngle()
{
	...
	std::size_t found = _quatTxt.find("4C-E8-17-79");
	...
	//float scale_on_elbow_angle = (3.1415/4) / (1700.0 - 2000.0);
	//elbow_angle_in_radians = (-2800.0 + temp_angle) * scale_on_elbow_angle;
	float scale_on_elbow_angle = (3.1415/2) / (1670.0 - 500.0);
	elbow_angle_in_radians = (-500.0 + temp_angle) * scale_on_elbow_angle;
	// float scale_on_elbow_angle = (3.1415/4) / (500.0 - 1670.0);
	// elbow_angle_in_radians = (-500.0 + temp_angle) * scale_on_elbow_angle;
	//endregion
